...
<section class="update-profile">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <img src="uploaded_img/<?= $fetch_profile['image']; ?>" alt="Ảnh đại diện">
      <div class="flex">
         <div class="inputBox">
            <span>Tên người dùng :</span>
            <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" placeholder="Nhập tên mới" required class="box">
            <span>Email :</span>
            <input type="email" name="email" value="<?= $fetch_profile['email']; ?>" placeholder="Nhập email mới" required class="box">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="Nhập mật khẩu hiện tại" class="box">
